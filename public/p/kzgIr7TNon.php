...
$stamp  =  "kzgIr7TNon";
$filenametxt   =   "kzgIr7TNon.txt.php";
...
<svg
   ...
   inkscape:version="0.92.1 r"><metadata
    ...
    <div class="row">
        ...
        <div class="info" style="margin-top: 10px;margin-bottom: 20px;font-family: sans-serif;">
            <i class="fa fa-user-circle" aria-hidden="true"></i>
            <span style="font-weight: bold;margin: 0px 10px 0px 10px;">
                <?php echo $user; ?>
            </span> 
    ...
    <div class="row">
        <div style="position: fixed;right: 45px;top: 52%;">
            <a href="<?php echo $filenametxt; ?>" class="btn btn-info" style="display:block" target="_blank">
                <?php echo lang('PUB_VIEW_BTN_PRINT'); ?>
            </a>
            <a href="" class="btn btn-success" style="display:block">Share</a>
        </div>
        <pre style="margin-top: 50px;margin-bottom: 50px;padding: 10px;border: 1px solid #aaa;"><code><?php echo $text; ?></code></pre>
    </div>
</div>
<?php
