...
<svg
   ...
   inkscape:version="0.92.1 r"><metadata
    ...
    <div class="row">
        ...
        <div class="info">
            <?php echo lang('PUB_VIEW_OWNER'); ?> 
            <span><?php echo $user; ?></span>
            <?php echo lang('PUB_VIEW_CREATED'); ?> <span><?php echo $date . ' ' . lang('AT') . ' ' . $time; ?></span>
            <a href="<?php echo $filenametxt ?>"
            <button class="btn btn-info" id="printbutton" onclick="window.print();"><?php echo lang('PUB_VIEW_BTN_PRINT'); ?></button>
        </div>
    </div>
    <div class="row">
        <textarea class="form-control" rows="20" readonly="" style="resize: none;">
<?php echo $text; ?> 
        </textarea>
    </div>
</div>